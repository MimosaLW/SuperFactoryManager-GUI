...
public final class SfmlEditorResourceBar {
    ...
    public static void onRenderPost(ScreenEvent.Render.Post event) {
        ...
        g.text(font, font.plainSubstrByWidth(label, nw - 6), nx + 4, by + 6, labelColor, false);
        ...
        g.centeredText(font, COPY.getComponent(), cxp + COPY_W / 2, by + 6,
        ...
        if (toastText != null && System.currentTimeMillis() < toastUntil) {
            ...
            g.text(font, toastText, bx + 2, ty + 2, 0xFF7CFC7C, false);
        } else {
            toastText = null;
        }
    }
